        ...
        <div className="space-y-2">
          ...
          <ul className="list-disc pl-5">
            {data.slice(0, 5).map((wbs, index) => {
              ...
              const formattedWbs = {
                ...wbs,
                startDate: wbs.startDate ? formatDate(wbs.startDate) : null,
                endDate: wbs.endDate ? formatDate(wbs.endDate) : null,
              };
              return (
                <li key={index}>
                  {formattedWbs.projectName} - {formattedWbs.projectDefinition}
                </li>
              );
            })}

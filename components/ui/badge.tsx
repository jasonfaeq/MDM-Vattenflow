  ...
  "inline-flex items-center justify-center rounded-md border px-2 py-0.5 text-xs font-medium w-fit whitespace-nowrap shrink-0 [&>svg]:size-3 gap-1 [&>svg]:pointer-events-none focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px] aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive transition-[color,box-shadow] overflow-hidden",
  {
    variants: {
      variant: {
        ...
        success:
          "border-transparent bg-green-500 dark:bg-green-900 text-white [a&]:hover:bg-green-600",
        warning:
        ...
        completed:
          "border-transparent bg-green-500 dark:bg-green-900 text-white [a&]:hover:bg-green-600",
        rejected:
          "border-transparent bg-red-500 dark:bg-red-900 text-white [a&]:hover:bg-red-600",
        inProgress:
          "border-transparent bg-blue-500 dark:bg-blue-600 text-white [a&]:hover:bg-blue-600",
        pendingInfo:
        ...
        locked:
          "border-transparent bg-gray-500 dark:bg-gray-600 text-white [a&]:hover:bg-gray-600",
        unlocked:
          "border-transparent bg-gray-500 dark:bg-gray-600 text-white [a&]:hover:bg-gray-600",
        modified:
          "border-transparent bg-gray-500 dark:bg-gray-600 text-white [a&]:hover:bg-gray-600",
